...
import poc.service.builder.service.persistence.SchoolUtil;
import poc.service.builder.service.persistence.impl.constants.POCPersistenceConstants;
...
public class SchoolPersistenceImpl
	 ...
	 */
	@Override
	public List<School> findByCity(String city, int start, int end) {
	...
	public School findByCity_First(
		...
		School school = fetchByCity_First(city, orderByComparator);
	...
	public School fetchByCity_First(
		...
		List<School> list = findByCity(city, 0, 1, orderByComparator);
	...
	public School findByCity_Last(
		...
		School school = fetchByCity_Last(city, orderByComparator);
	...
	public School[] findByCity_PrevAndNext(
		...
		try {
			...
			array[0] = getByCity_PrevAndNext(
				session, school, city, orderByComparator, true);

			array[1] = school;

			array[2] = getByCity_PrevAndNext(
				session, school, city, orderByComparator, false);
	...
	protected School getByCity_PrevAndNext(
		Session session, School school, String city,
		OrderByComparator<School> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_CITY_CITY_2 = "school.city = ?";

	private static final String _FINDER_COLUMN_CITY_CITY_3 =
		"(school.city IS NULL OR school.city = '')";
	...
	public void cacheResult(School school) {
		entityCache.putResult(SchoolImpl.class, school.getPrimaryKey(), school);
	...
	public void cacheResult(List<School> schools) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (schools.size() > _valueObjectFinderCacheListThreshold))) {
	...
	public void clearCache() {
		...
		finderCache.clearCache(SchoolImpl.class);
	}
	...
	public void clearCache(School school) {
		entityCache.removeResult(SchoolImpl.class, school);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(SchoolImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(SchoolModelImpl schoolModelImpl) {
		...
		finderCache.putResult(_finderPathFetchByUUID_G, args, schoolModelImpl);
	}
	...
	public School updateImpl(School school) {
		...
		if (isNew && (school.getCreateDate() == null)) {
			if (serviceContext == null) {
				...
				school.setCreateDate(serviceContext.getCreateDate(date));
			}
		}

		if (!schoolModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				school.setModifiedDate(date);
			}
			else {
				school.setModifiedDate(serviceContext.getModifiedDate(date));
			}
		}
		...
		entityCache.putResult(SchoolImpl.class, schoolModelImpl, false, true);
	...
	public void activate() {
		...
		SchoolUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		SchoolUtil.setPersistence(null);
