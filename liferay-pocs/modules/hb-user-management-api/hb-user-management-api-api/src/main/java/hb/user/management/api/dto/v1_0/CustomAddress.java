 ...
 */
@Generated("")
@GraphQLName("CustomAddress")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CustomAddress")
public class CustomAddress implements Serializable {

	public static CustomAddress toDTO(String json) {
		return ObjectMapperUtil.readValue(CustomAddress.class, json);
	}

	public static CustomAddress unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(CustomAddress.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "hb.user.management.api.dto.v1_0.CustomAddress",
		name = "x-class-name"
	)
