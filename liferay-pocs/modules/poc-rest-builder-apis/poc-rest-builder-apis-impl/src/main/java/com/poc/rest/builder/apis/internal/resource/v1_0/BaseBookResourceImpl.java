...
public abstract class BaseBookResourceImpl
	implements BookResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<Book> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/poc-rest-builder-apis/v1.0/books'  -u 'test@liferay.com:test'
	 */
	...
	public void create(
			Collection<Book> books, Map<String, Serializable> parameters)
		throws Exception {
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<Book>, UnsafeFunction<Book, Book, Exception>, Exception>
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<Book>, UnsafeConsumer<Book, Exception>, Exception>
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseBookResourceImpl.class);
