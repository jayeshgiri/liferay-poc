 ...
 */
@Generated("")
@GraphQLName("HelloResponse")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "HelloResponse")
public class HelloResponse implements Serializable {

	public static HelloResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(HelloResponse.class, json);
	}

	public static HelloResponse unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(HelloResponse.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "liferay.jwt.custom.token.dto.v1_0.HelloResponse",
		name = "x-class-name"
	)
