...
public abstract class BaseHelloResponseResourceImpl
	implements HelloResponseResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/liferay-jwt-custom-token/v1.0/hello'  -u 'test@liferay.com:test'
	 */
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseHelloResponseResourceImpl.class);
