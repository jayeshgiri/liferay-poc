...
public abstract class BaseJWTTokenResponseResourceImpl
	implements JWTTokenResponseResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/liferay-jwt-custom-token/v1.0/getJwtToken'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(value = {})
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/getJwtToken")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/liferay-jwt-custom-token/v1.0/getDecodedJwtToken' -d $'{"encodedToken": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(value = {})
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path("/getDecodedJwtToken")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseJWTTokenResponseResourceImpl.class);
